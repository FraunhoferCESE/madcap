 ...
 */
@Entity
public class VolumeEntry implements Comparable<VolumeEntry>, DatastoreEntry {
    @Id
    private String id;
    @Index
    ...
    public VolumeEntry(ProbeEntry probeEntry){
        id = probeEntry.getId();
        ...
        volume = dataJsonObject.getInt("volume");
    }
     ...
     */
    @Override
    public int compareTo(VolumeEntry o) {
        return 0;
    }
    ...
    public boolean equals(Object o) {
        ...
        VolumeEntry that = (VolumeEntry) o;
        return kind.equals(that.getKind()) && (volume == that.getVolume());
    }
