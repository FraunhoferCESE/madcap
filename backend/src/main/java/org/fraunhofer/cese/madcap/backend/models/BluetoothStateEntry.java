 ...
 *
 * Model class for bluetooth states.
 */
@Entity
public class BluetoothStateEntry implements Comparable<BluetoothStateEntry>, DatastoreEntry {
    ...
    public BluetoothStateEntry(){
    }

    public BluetoothStateEntry(ProbeEntry probeEntry){
        id = probeEntry.getId();
     ...
     */
    @Override
    public int compareTo(BluetoothStateEntry o) {
        return 0;
    }
    ...
    public boolean equals(Object o) {
        ...
        BluetoothStateEntry that = (BluetoothStateEntry) o;
