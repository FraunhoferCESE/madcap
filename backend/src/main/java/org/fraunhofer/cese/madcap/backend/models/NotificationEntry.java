 ...
 */
@Entity
public class NotificationEntry implements Comparable<NotificationEntry>, DatastoreEntry {
    @Id
    private String id;
    @Index
    ...
    public NotificationEntry(ProbeEntry probeEntry){
        id = probeEntry.getId();
        ...
        pack = dataJsonObject.getString("pack");
        ticker = dataJsonObject.getString("ticker");
        title = dataJsonObject.getString("title");
        text = dataJsonObject.getString("text");
    }
     ...
     */
    @Override
    public int compareTo(NotificationEntry o) {
        return 0;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (pack.equals(that.getPack()) &&
                ticker.equals(that.getTicker()) &&
