 ...
 *
 * Model class for CallStateProbes.
 */
@Entity
public class CallStateEntry implements Comparable<CallStateEntry>, DatastoreEntry {
    @Id
    private String id;
    @Index
    ...
    public CallStateEntry(){
    }

    public CallStateEntry(ProbeEntry probeEntry){
        id = probeEntry.getId();
     ...
     */
    @Override
    public int compareTo(CallStateEntry o) {
        return 0;
    }
    ...
    public boolean equals(Object o) {
        ...
        CallStateEntry that = (CallStateEntry) o;
