 ...
 */
@Entity
public class RingerEntry implements Comparable<RingerEntry>, DatastoreEntry {
    @Id
    private String id;
    @Index
    ...
    public RingerEntry(ProbeEntry probeEntry){
        id = probeEntry.getId();
        ...
        mode = dataJsonObject.getString("mode");
    }
     ...
     */
    @Override
    public int compareTo(RingerEntry o) {
        return 0;
    }
    ...
    public boolean equals(Object o) {
        ...
        RingerEntry that = (RingerEntry) o;
        return mode.equals(that.getMode());
    }
