...
/**
 * Created by MMueller on 11/16/2016.
 */

@Entity
public class LocationServiceEntry implements Comparable<LocationEntry>, DatastoreEntry {
    ...
    public LocationServiceEntry(ProbeEntry probeEntry){
        ...
        locationServiceStatus = dataJsonObject.getString("LocationServiceStatus");
    }
    ...
    public boolean equals(Object o) {
        ...
        LocationServiceEntry that = (LocationServiceEntry) o;

        if (id != null ? !id.equals(that.id) : that.id != null) return false;
        if (timestamp != null ? !timestamp.equals(that.timestamp) : that.timestamp != null)
            return false;
        if (locationServiceStatus != null ? !locationServiceStatus.equals(that.locationServiceStatus) : that.locationServiceStatus !=null)
            return false;
