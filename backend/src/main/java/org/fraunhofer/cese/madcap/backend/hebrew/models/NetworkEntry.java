 ...
 */
@Entity
public class NetworkEntry implements Comparable<NetworkEntry>, DatastoreEntry {
    @Id
    private String id;
    @Index
    ...
    public NetworkEntry(ProbeEntry probeEntry){
        id = probeEntry.getId();
        ...
        info = dataJsonObject.getString("info");
    }
    ...
    public boolean equals(Object o) {
        ...
        NetworkEntry that = (NetworkEntry) o;
        return (state.equals(that.getState()) && info.equals(that.getInfo()));
    }
