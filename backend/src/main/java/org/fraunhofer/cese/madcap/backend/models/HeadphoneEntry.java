 ...
 */
@Entity
public class HeadphoneEntry implements Comparable<HeadphoneEntry>, DatastoreEntry {
    @Id
    private String id;
    @Index
    ...
    public HeadphoneEntry(){
    }

    public HeadphoneEntry(ProbeEntry probeEntry){
        id = probeEntry.getId();
        ...
        plugState = dataJsonObject.getString("plugState");
    }

    /**
     * Gets the plugState.
     * @return the plugState.
     */
     ...
     */
    @Override
    public int compareTo(HeadphoneEntry o) {
        return 0;
    }
    ...
    public boolean equals(Object o) {
        ...
        HeadphoneEntry that = (HeadphoneEntry) o;
        return plugState.equals(that.getPlugState());
    }
