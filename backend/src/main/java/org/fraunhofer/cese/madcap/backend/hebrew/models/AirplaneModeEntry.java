 ...
 */
@Entity
public class AirplaneModeEntry implements Comparable<AirplaneModeEntry>, DatastoreEntry {
    ...
    public AirplaneModeEntry(){
    }

    public AirplaneModeEntry(ProbeEntry probeEntry){
        id = probeEntry.getId();
    ...
    @Override
    public int compareTo(AirplaneModeEntry o) {
        return 0;
    }
