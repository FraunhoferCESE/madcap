 ...
 */
@Entity
public class PowerEntry implements  Comparable<PowerEntry>, DatastoreEntry{
    @Id
    private String id;
    @Index
    ...
    public PowerEntry(ProbeEntry probeEntry){
        id = probeEntry.getId();
    ...
    @Override
    public int compareTo(PowerEntry o) {
        return 0;
    }
    ...
    public boolean equals(Object o) {
        ...
        PowerEntry that = (PowerEntry) o;
        return (remainingPower == that.getRemainingPower());
    }
