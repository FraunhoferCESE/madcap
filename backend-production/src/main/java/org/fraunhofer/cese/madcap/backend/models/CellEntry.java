 ...
 */
@Entity
public class CellEntry implements Comparable<CellEntry>, DatastoreEntry {
    @Id
    private String id;
    @Index
    ...
    public CellEntry(ProbeEntry probeEntry){
        id = probeEntry.getId();
     ...
     */
    @Override
    public int compareTo(CellEntry o) {
        return 0;
    }
