 ...
 */
@Entity
public class VoicemailEntry implements Comparable<VoicemailEntry>, DatastoreEntry {
    @Id
    private String id;
    @Index
    ...
    public VoicemailEntry(ProbeEntry probeEntry){
        id = probeEntry.getId();
     ...
     */
    @Override
    public int compareTo(VoicemailEntry o) {
        return 0;
    }
    ...
    public boolean equals(Object o) {
        ...
        VoicemailEntry that = (VoicemailEntry) o;
