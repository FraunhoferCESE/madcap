 ...
 */
public class BluetoothProbe2 extends Probe.Base implements Probe.PassiveProbe {
    ...
    public BluetoothProbe2(BluetoothAdapter bluetoothAdapter, Context context, JsonObjectFactory jsonObjectFactory) {
        super(context);
        this.bluetoothAdapter = bluetoothAdapter;
        this.jsonObjectFactory = jsonObjectFactory;
    }

    public BluetoothProbe2(BluetoothAdapter bluetoothAdapter, Context context) {
        this(bluetoothAdapter, context, null);
    }

    public BluetoothProbe2() {
    ...
    public class BluetoothInformationReceiver extends BroadcastReceiver {
        ...
        public BluetoothProbe2 callback;

        public BluetoothInformationReceiver(BluetoothProbe2 callback) {
